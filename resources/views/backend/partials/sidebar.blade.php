...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
        <img src="{{ URL::asset('backend')}}/dist/img/AdminLTELogo.png" alt="AdminLTE Logo"
             ...
             style="opacity:.8">
        <span class="brand-text font-weight-light">POS Admin</span>
    </a>
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                @if(Auth::user()->role_id==1)
                    ...
                    <li class="nav-item has-treeview {{($prefix=='/suppliers')?'menu-open':''}}">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{route('admin.suppliers.view')}}" class="nav-link {{($route=='admin.suppliers.view')?'active':''}}">
                                    <i class="far fa-list-alt"></i>
                                    <p>Suppliers</p>
                                </a>
                            </li>
                    ...
                    <li class="nav-item has-treeview {{($prefix=='/customers')?'menu-open':''}}">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{route('admin.customers.view')}}" class="nav-link {{($route=='admin.customers.view')?'active':''}}">
                                    <i class="far fa-list-alt"></i>
                                    <p>Customers</p>
                                </a>
                            </li>
                                   ...
                                   class="nav-link {{($route=='admin.brand.view')?'active':''}}">
                                    ...
                                    <p>Brands</p>
                                        ...
                                        <li class="nav-item has-treeview {{($prefix=='/category')?'menu-open':''}}">
                                            ...
                                            <ul class="nav nav-treeview">
                                                <li class="nav-item">
                                                    <a href="{{route('logged_in.user.view')}}" class="nav-link {{($route=='logged_in.user.view')?'active':''}}">
                                                        <i class="far fa-list-alt"></i>
                                                        <p>Categories</p>
                                                    </a>
                                                </li>
